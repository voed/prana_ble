...
void PranaBLE::gattc_event_handler(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if,
  ...
  switch (event) {
    ...
    case ESP_GATTC_REG_FOR_NOTIFY_EVT: {
      ...
      //}
      uint8_t notify_en = 1;
      auto status = esp_ble_gattc_write_char_descr(this->parent()->gattc_if, this->parent()->conn_id, param->reg_for_notify.handle, sizeof(notify_en),
    ...
    case ESP_GATTC_READ_CHAR_EVT: {
      ...
      ESP_LOGW(TAG, "Data %d len", param->read.value_len);
